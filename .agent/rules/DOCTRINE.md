...
### 1. 🇰🇷 절대 한국어 원칙 (Absolute Korean Rule)

- **모든** 대화, 계획서(`IMPLEMENTATION_PLAN.md`), 결과 보고, 주석, 커밋 메시지는 **반드시 한국어**로 작성합니다.
...
5. **Proactive Suggestion**: 사용자가 요청한 것만 수동적으로 수행하지 마십시오. 보안 취약점, 성능 저하, 구조적 부채가 보이면 즉시 경고하고 개선안을 제안하십시오.
